(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('rxjs/index'), require('@angular/core'), require('@angular/common'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('facephi-selphid', ['exports', 'rxjs', 'rxjs/operators', 'rxjs/index', '@angular/core', '@angular/common', '@angular/common/http'], factory) :
    (factory((global['facephi-selphid'] = {}),global.rxjs,global.rxjs.operators,global.rxjs.index,global.ng.core,global.ng.common,global.ng.common.http));
}(this, (function (exports,rxjs,operators,index,i0,i1,i2) { 'use strict';
    ...
    var FPhiSelphIdWidgetService = /** @class */ (function () {
        ...
        /** @nocollapse */
        FPhiSelphIdWidgetService.ctorParameters = function () {
            return [
    ...
    var FacePhiSelphIdComponent = /** @class */ (function () {
        ...
        function FacePhiSelphIdComponent(widgetService) {
             ...
             */
            this.onExtractionFinished = new i0.EventEmitter();
            /**
             * Evento lanzado cuando el usuario cancela el proceso de extracción.
             */
            this.onUserCancelled = new i0.EventEmitter();
            /**
        ...
        /** @nocollapse */
        FacePhiSelphIdComponent.ctorParameters = function () {
            return [
        ...
        FacePhiSelphIdComponent.propDecorators = {
            ...
            captureMode: [{ type: i0.Input }],
            previewCapture: [{ type: i0.Input }],
            documentDimensions: [{ type: i0.Input }],
            qualityThreshold: [{ type: i0.Input }],
            cropFactor: [{ type: i0.Input }],
            forceLandscape: [{ type: i0.Input }],
            canvasHD: [{ type: i0.Input }],
            initialTip: [{ type: i0.Input }],
            cameraWidth: [{ type: i0.Input }],
            cameraHeight: [{ type: i0.Input }],
            cameraId: [{ type: i0.Input }],
            captureTimeout: [{ type: i0.Input }],
            captureRetries: [{ type: i0.Input }],
            captureSensibility: [{ type: i0.Input }],
            ...
            onExtractionFinished: [{ type: i0.Output }],
            onUserCancelled: [{ type: i0.Output }],
    ...
    exports.FacePhiSelphIdComponent = FacePhiSelphIdComponent;
    exports.FPhiSelphIdConfiguration = FPhiSelphIdConfiguration;
    exports.FPhiSelphIdDocumentDimensions = FPhiSelphIdDocumentDimensions;
    exports.FPhiSelphIdConstants = FPhiSelphIdConstants;
    exports.FPhiSelphIdWidgetService = FPhiSelphIdWidgetService;
    exports.FacePhiSelphIdModule = FacePhiSelphIdModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=facephi-selphid.umd.js.map