 ...
 * Modelo con la información de configuración del widget Selphi.
 */
export { FPhiSelphIdConfiguration };
if (false) {
    /**
 ...
 * Datos de dimensiones del documento capturado por el widget.
 */
export { FPhiSelphIdDocumentDimensions };
if (false) {
    /** @type {?} */
